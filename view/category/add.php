...
<body>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="name_category"  required>
            <div class="invalid-feedback">
        Mời nhập tên danh mục
            </div>
        </div>
    </div>
   
    <div class="col-12">
        <button class="btn btn-primary" name="adddm" type="submit">Thêm Danh Mục</button>
    </div>
    <?php
        if(isset($thongbao)){
            echo $thongbao;
